...
//
  [LAYERS] = LAYOUT_moonlander(
    ____________ , DF(BEPO__)   , TO(SYMBOL)   , TO(MEDIA_)   , DF(B4AZER)   , TO(COLORS)   , ____________          ,          ____________ , ____________ , ____________ , ____________ , ____________ , ____________ , ____________ ,
...
//
  [SYMBOL] = LAYOUT_moonlander(
    ...
    ____________ , RST_LAYER    , ____________ , ____________ , ____________ ,                ____________          ,          ____________                , KC_KP_0      , KC_KP_DOT    , KC_KP_EQUAL  , KC_KP_SLASH  , ____________ ,
                                                                ____________ , ____________ , ____________          ,          ____________ , ____________ , ____________
  ),
//
...
//│         │         │         │         │         │         │                                 │         │         │   Prev  │  Next   │         │         │
//├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┘                                 └─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤
//│         │Rst layer│         │         │         │  ╔═════════════╗                   ╔═════════════╗  │ Vol. UP │Vol. DOWN│   MUTE  │         │         │
//└─────────┴─────────┴─────────┴─────────┴─────────┘  ║             ║                   ║             ║  └─────────┴─────────┴─────────┴─────────┴─────────┘
//                                                     ║             ║                   ║             ║
//                                                     ╠══════╦══════╬══════╗     ╔══════╬══════╦══════╣
//                                                     ║Mouse ║Mouse ║Mouse ║     ║      ║      ║      ║
...
//
  [MEDIA_] = LAYOUT_moonlander(
    ...
    ____________ , RST_LAYER    , ____________ , ____________ , ____________ ,                ____________          ,          ____________             , KC_AUDIO_VOL_UP , KC_AUDIO_VOL_DOWN , KC_AUDIO_MUTE , ____________ , ____________ ,
...
//
  [COLORS] = LAYOUT_moonlander(
    ...
    ____________ , ____________ , ____________ , ____________ , ____________ , ____________ ,                                                 ____________ , ____________ , ____________ , ____________ , ____________ , ____________ ,
    ____________ , RST_LAYER    , ____________ , ____________ , ____________ ,                RGB_MOD               ,          RGB_TOG                     , ____________ , ____________ , ____________ , ____________ , ____________ ,
